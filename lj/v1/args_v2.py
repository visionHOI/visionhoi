...
def get_args():
    ...
    # ====================== 新增：语义适配器专用学习率 ======================
    parser.add_argument('--lr-text-adapter', default=5e-4, type=float,
                        help='学习率：文本语义适配器（低秩层）')
    ...
    parser.add_argument('--use_text_adapter', action='store_true',
                        help='启用文本语义适配器（含低秩分解）')
    parser.add_argument('--lora_rank', type=int, default=2,
                        help='低秩分解的秩（教授建议默认2）')
    parser.add_argument('--lora_alpha', type=int, default=8,
                        help='低秩层缩放系数（教授建议默认8，保持scale=alpha/rank=4）')
    parser.add_argument('--text_adapter_dim', type=int, default=64,
                        help='文本语义适配器瓶颈层维度（默认64）')
